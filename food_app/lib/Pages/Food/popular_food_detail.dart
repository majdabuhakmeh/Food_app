...
class PopularFoodDetail extends StatelessWidget {
  final int pageId;
  final String page;
   const PopularFoodDetail({super.key, required this.pageId,required String this.page});
          ...
          Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Flexible(child: AppColumn(text: product.name!)),
              ...
              child: Row(
                children: [
                 GestureDetector(
                  ...
                  child:Icon(Icons.remove,color: AppColors.signColor,)),                  SizedBox(width:Dimensions.width10/2),
