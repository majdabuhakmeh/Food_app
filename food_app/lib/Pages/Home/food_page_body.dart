...
class FoodPageBody extends StatefulWidget {
  ...
  @override
  State<FoodPageBody> createState() => _FoodPageBodytState();
}

class _FoodPageBodytState extends State<FoodPageBody> {
  ...
  Widget _buildPageItem(int index, ProductModel poplularProduct){
            ...
            children: [
                ...
                child:Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: NetworkImage(
                            AppConstants.baseUrl+AppConstants.uploadUrl+poplularProduct.img!,
                          )
                      )
                  ),
                ),
              ...
              Align(
                ...
                Container(
                  ...
                  child: Container(
                    padding: EdgeInsets.only(top:Dimensions.height15,left: Dimensions.width15,right: Dimensions.height15),
                    child:AppColumn(text: poplularProduct.name!),
